...
const buttonVariants = cva("inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0", {
  variants: {
    variant: {
      ...
      "elp-solid": "btn-metal gold-sweep shadow-md text-white",
      "elp-outline": "border-2 border-primary text-primary bg-transparent hover:bg-primary hover:text-white",
      "elp-white": "bg-white text-primary hover:bg-white/90 shadow-md border border-border",
      "elp-white-outline": "border-2 border-white/80 text-white bg-transparent hover:bg-white/10",
      // Premium gold variants
      "elp-gold": "bg-gradient-to-r from-gold-dark via-gold to-gold-light text-primary-foreground shadow-md hover:shadow-lg gold-sweep",
      "elp-gold-outline": "btn-gold-outline",
    },
    size: {
